...
//        final Typeface typeface = TypefaceUtils.load(assetManager, ViewUtil.getFontPath(textView, filePath));
...
//            try {
//                Class.forName("com.fortunemaster.android.widget.RegularFontTextView");
