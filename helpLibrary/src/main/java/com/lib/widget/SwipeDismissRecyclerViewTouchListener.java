...
public class SwipeDismissRecyclerViewTouchListener implements View.OnTouchListener {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (mItemClickCallback != null
                        && pressDuration < MAX_CLICK_DURATION
                        && distance(pressedX, pressedY, motionEvent.getX(), motionEvent.getY()) < mSlop) {
    ...
    private void performDismiss(final View dismissView, final int dismissPosition) {
        ...
        final int originalHeight = mIsVertical ? dismissView.getWidth() : dismissView.getHeight();
