...
public class LoadingDots extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        mAutoPlay = a.getBoolean(R.styleable.LoadingDots_ldots_autoPlay, true);

        mDotsColor = a.getColor(R.styleable.LoadingDots_ldots_dotsColor, Color.GRAY);
        mDotsCount = a.getInt(R.styleable.LoadingDots_ldots_dotsCount, DEFAULT_DOTS_COUNT);
        mDotSize = a.getDimensionPixelSize(R.styleable.LoadingDots_ldots_dotsSize,
                resources.getDimensionPixelSize(R.dimen.loadingdots_size_default));
        mDotSpace = a.getDimensionPixelSize(R.styleable.LoadingDots_ldots_dotsSpace,
                resources.getDimensionPixelSize(R.dimen.loadingdots_space_default));

        mLoopDuration = a.getInt(R.styleable.LoadingDots_ldots_loopDuration, DEFAULT_LOOP_DURATION);
        mLoopStartDelay = a.getInt(R.styleable.LoadingDots_ldots_loopStartDelay, DEFAULT_LOOP_START_DELAY);

        mJumpDuration = a.getInt(R.styleable.LoadingDots_ldots_jumpDuration, DEFAULT_JUMP_DURATION);
        mJumpHeight = a.getDimensionPixelSize(R.styleable.LoadingDots_ldots_jumpHeight,
    ...
    private View createDotView(Context context) {
        ...
        dot.setImageResource(R.drawable.shape_loading_dot);
