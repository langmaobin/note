...
/**
 * Latest update 30-04-2017
 * - add setDeChild()
 * - update onInterceptTouchEvent()
 * Reference: https://github.com/baoyongzhang/android-PullRefreshLayout
 */
public class PullRefreshLayout extends ViewGroup {
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.CustomPullRefreshLayout_cprl_refreshType, STYLE_MATERIAL);
        final int colorsId = a.getResourceId(R.styleable.CustomPullRefreshLayout_cprl_refreshColors, 0);
        final int colorId = a.getResourceId(R.styleable.CustomPullRefreshLayout_cprl_refreshColor, 0);
        final int bgColorId = a.getResourceId(R.styleable.CustomPullRefreshLayout_cprl_backgroundColor, 0);
        a.recycle();
        ...
        if (bgColorId > 0) {
            mRefreshView.setBackgroundColor(ContextCompat.getColor(context, bgColorId));
        }
...
//        mRefreshView.measure(MeasureSpec.makeMeasureSpec(mRefreshViewWidth, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(mRefreshViewHeight, MeasureSpec.EXACTLY));
    ...
    /**
     * @param deChild - the root child view within pull refresh layout
     */
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mRefreshing) {
                    ...
                    // Fixed smartisan drawable fast drag issue
