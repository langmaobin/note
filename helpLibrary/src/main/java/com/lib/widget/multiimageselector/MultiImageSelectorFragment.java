package com.lib.widget.multiimageselector;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mCategoryText.setText(getActivity().getString(R.string.mis_folder_all));
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    intent.putExtra(MediaStore.EXTRA_OUTPUT,
                            FileProvider.getUriForFile(getContext(), getActivity().getPackageName() + ".provider", mTmpFile)/*Uri.fromFile(mTmpFile)*/);
            ...
            if (mode == MODE_MULTI) {
                if (resultList.contains(image.path)) {
                    ...
                    if (selectImageCount() == resultList.size()) {
                        Toast.makeText(getActivity(), R.string.__T_global_text_image_limit, Toast.LENGTH_SHORT).show();
                        return;
                    }
