package com.lib.widget.pinnedheaderlistview;
...
public abstract class SearchablePinnedHeaderListViewAdapter<T> extends IndexedPinnedHeaderListViewAdapter
    ...
    /**
     * returns true if the item can "pass" the filtering process and should be shown
     */
    ...
    public int getCount() {
        final ArrayList<T> listCopy = getFilterListCopy();
        if (listCopy != null) return listCopy.size();
