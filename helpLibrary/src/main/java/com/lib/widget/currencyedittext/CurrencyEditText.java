...
public class CurrencyEditText extends AppCompatEditText {
    ...
    private Locale locale = new Locale("ms", "MY"); // getResources().getConfiguration().locale;

    private Currency currency;

    private Locale defaultLocale = new Locale("ms", "MY");
...
//    }
    ...
    public void setCurrencyTextWatcher(CurrencyTextWatcher currencyTextWatcher) {
        if (textWatcher != null) {
            this.removeTextChangedListener(textWatcher);
        }
        textWatcher = currencyTextWatcher;
    ...
    public String formatCurrency(String val) {
        return CurrencyTextFormatter.formatText(val, currency, locale, defaultLocale, showCurrencySymbol);
    }
    ...
    public String formatCurrency(long rawVal) {
        return CurrencyTextFormatter.formatText(String.valueOf(rawVal), currency, locale, defaultLocale, showCurrencySymbol);
    }
    ...
    private void processAttributes(Context context, AttributeSet attrs) {
        ...
        boolean defaultHintAttrVal = array.getBoolean(R.styleable.CurrencyEditText_cet_enableDefaultHint, true);
        showCurrencySymbol = array.getBoolean(R.styleable.CurrencyEditText_cet_showCurrencySymbol, true);
        if (textWatcher != null) {
            textWatcher.setShowCurrencySymbol(showCurrencySymbol);
        }
        configureHint(defaultHintAttrVal);
        this.setAllowNegativeValues(array.getBoolean(R.styleable.CurrencyEditText_cet_allowNegativeValues, false));
        array.recycle();
    }
