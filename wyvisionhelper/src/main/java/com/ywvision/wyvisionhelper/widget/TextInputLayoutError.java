...
/**
 * Created by SzeGuan on 4/3/2017.
 */

public class TextInputLayoutError extends TextInputLayout {
    public TextInputLayoutError(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public TextInputLayoutError(Context context) {
        super(context);
    }

    public TextInputLayoutError(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
